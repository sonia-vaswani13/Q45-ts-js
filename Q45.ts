//Q45.Cars: Write a function that stores information about a car in a Object.
 ...
 function creatCar (manufacturer: string, modelName: string, ...options: Record<string, any>[]):  Record<string, any>{
 ...
 const carInfo = creatCar('ford','Raptor',{ color:'balck',year: 2023, feature:["transmission","automatic"]});
 console.log(carInfo)
